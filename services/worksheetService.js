...
// next month rule used across the app. Shared by worksheet month summaries
// (below) and receipt building (services/paymentService.js), which is why
// this stays here rather than moving to paymentService.js with the rest of
// the billing logic.
...
export async function getEnrollmentRow(enrollmentId, { activeOnly = true } = {}) {
